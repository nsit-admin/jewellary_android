...
import {
    signupExisting, signupNew, login, schemes, payment, isAuth, paymentUpdate,
    schemesAddition, sendOtp, verifyOtp, forgotPassword, resendOtp, getRates, cashPayment, paymentStatus
...
router.post('/api/cashPayment', cashPayment);
