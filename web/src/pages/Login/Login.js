            ...
            <div className="container">
                ...
                <div className="form">
                    ...
                    <div className="formContainer">
                        ...
                        {(screenType === 'SignUpNew' || screenType === 'SignIn') && isOtpSent && !isOtpVerified && <input type="password" onInput={e => maxLengthCheck(e, 6)} maxLength={6} value={otp} name="otp" placeholder="otp" onChange={e => setOtp(e.target.value)} />}
